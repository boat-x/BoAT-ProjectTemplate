...
class ConfigContentGen():
    ...
    def gen_blockchain(self,pf):  
        ...
        self.config_content += 'ifeq ($(BOAT_PROTOCOL_USE_ETHEREUM)_$(BOAT_PROTOCOL_USE_PLATON)_$(BOAT_PROTOCOL_USE_QUORUM)), 0_0_0)\n'
    ...
    def gen_gccversion(self):
        ...
        self.config_content += 'LANG := en_US\n'
        self.config_content += '\n'
    ...
    def gen_targets(self):
        ...
        self.config_content += '	cppcheck  --enable=all -i$(BOAT_BASE_DIR)/sdk/third-party/ -i$(BOAT_BASE_DIR)/BoAT-SupportLayer/vendor/crypto/ --force $(BOAT_BASE_DIR) \n'
        self.config_content += '\n'
    ...
    def clonerepo(self,reponame):
       ...
       # choose the tag / branch
        ...
        cmd1 = 'git clone' + branch_name + ' https://github.com/boat-x/' + reponame + '.git'
        cmd2 = 'git clone' + branch_name + ' git@github.com:boat-x/' + reponame + '.git'
